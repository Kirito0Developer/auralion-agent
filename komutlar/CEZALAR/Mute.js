...
exports.run = async (client, message, args) => {
  ...
  if (seçim == "bilgi") {
    ...
    let arr2 = await rolAyarlarDB.get(`rolayarlar.mute_users`) || ["683707976468398227"]
    ...
    let embed = new MessageEmbed()
      ...
      .addField(`<:asgard_kirmizi_ok:939958836377292831> **Nasıl kullanılır?**`, `Susturmak için \`${prefix[0]}mute @etiket [sebep] [süre]\` komutunu kullan.`)
      .addField(`<:asgard_mavi_parlak_yildiz:939958604532940871> **Cezayı nasıl kaldıracağım?**`, `Susturmayı kaldırmak için \`${prefix[0]}unmute @etiket\` komutunu kullan.`)
      .addField("<:asgard_kirmizi_ok:939958836377292831> **Komutu kimler kullanabilir?**", "Bu komutu **Yönetici** - **Mute Sorumlusu** ya da **Üyeleri Sustur** yetkisine sahip olan kişiler kullanabilir.")
      .addField(`<:asgard_mavi_parlak_yildiz:939958604532940871> **Belirlediğim rollere koyabiliyor muyum?**`, `Eğer belirlediğin rollere koymak istiyorsan bunun için \n\`${prefix[0]}mute yetkiler [roller/idler]\` komutunu kullanmalısın.`)
      .addField(`<:asgard_mavi_parlak_yildiz:939958604532940871> **Belirlediğim kişileri koyabiliyor muyum?**`, `Eğer belirlediğin kişileri koymak istiyorsan bunun için \n\`${prefix[0]}mute kişiler [kişiler/idler]\` komutunu kullanmalısın.`)
      .addField(`<:asgard_kirmizi_ok:939958836377292831> **Belirlediğim kanala loglatabiliyor muyum?**`, `Eğer belirlediğin kanala loglatmak isteiyorsan bunun için \n\`${prefix[0]}mute kanal [kanal/id]\` komutunu kullanmalısın.`)
    ...
    if (seçim == "yetkiler") {
      ...
      if (roles.length <= 0)
        return await message.channel.send(new MessageEmbed()
          .setColor("#FF6553")
          .setTitle("<:asgard_mavi_parlak_yildiz:939958604532940871> Komutu Yanlış Kullandın!")
