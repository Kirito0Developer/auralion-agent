...
exports.run = async (client, message, args) => {
  ...
  if (seçim == "bilgi") {
    ...
    let arr2 = await rolAyarlarDB.get(`rolayarlar.jail_users`) || ["683707976468398227"]
    ...
    let embed = new MessageEmbed()
      .setTitle(`<:asgard_dev:939961596329988176> Jail/Karantina Nedir?`)
      .setColor("RANDOM")
      .setThumbnail("https://cdn.discordapp.com/attachments/698398041518112898/699061417982165033/Melancholy.gif")
      .setDescription(`Sunucu içerisinde olumsuz davranışlar sergileyen veya sunucu kurallarının dışına çıkan ya da isteğe bağlı bir şekilde sohbete/sesli sohbette görememesi/erişememesi için verilen cezadır.`)
      .addField(`<:asgard_onay_rozet:939959006657663006> **Nasıl kullanılır?**`, `Jail Atmak için \`${prefix[0]}temp-jail @etiket [sebep]\` komutunu kullan.`)
      .addField(`<:asgard_onay_rozet:939959006657663006> **Cezayı nasıl kaldıracağım?**`, `aili kaldırmak için \`${prefix[0]}unjail @etiket\` komutunu kullan.`)
      .addField("<:asgard_onay_rozet:939959006657663006> **Komutu kimler kullanabilir?**", "Bu komutu **Yönetici** ya da **Jail Sorumlusu** yetkisine sahip olan kişiler kullanabilir.")
      .addField(`<:asgard_onay_rozet:939959006657663006> **Belirlediğim rollere koyabiliyor muyum?**`, `Eğer belirlediğin rollere koymak istiyorsan bunun için \n\`${prefix[0]}temp-jail yetkiler [roller/idler]\` komutunu kullanmalısın.`)
      .addField(`<:asgard_onay_rozet:939959006657663006> **Belirlediğim kişileri koyabiliyor muyum?**`, `Eğer belirlediğin kişileri koymak istiyorsan bunun için \n\`${prefix[0]}temp-jail kişiler [kişiler/idler]\` komutunu kullanmalısın.`)
      .addField(`<:asgard_onay_rozet:939959006657663006> **Belirlediğim kanala loglatabiliyor muyum?**`, `Eğer belirlediğin kanala loglatmak isteiyorsan bunun için \n\`${prefix[0]}temp-jail kanal [kanal/id]\` komutunu kullanmalısın.`)
  ...
  if (message.member.permissions.has("ADMINISTRATOR") && seçim != "bilgi") {
    if (seçim == "yetkiler") {
      ...
      if (roles.length <= 0)
        return await message.channel.send(new MessageEmbed()
          .setColor("#FF6553")
          .setTitle("<:asgard_kalkan:939961737296347197> Komutu Yanlış Kullandın!")
          ...
          .addField(`<:asgard_mavi_parlak_yildiz:939958604532940871> Örnek`, `\`\`\`${prefix[0]}temp-jail yetkiler @rol1 @rol2 @rol3\`\`\``, true)
          .setThumbnail("https://cdn.discordapp.com/attachments/698398041518112898/699064766626267188/giphy.gif")
          .addField(`<:asgard_mavi_parlak_yildiz:939958604532940871> Örnek`, `\`\`\`${prefix[0]}temp-jail yetkiler ID1 ID2 ID3\`\`\``, true)
          .setFooter(message.author.username + " Tarafından kullanıldı.", message.author.avatarURL({
            dynamic: true
          })));
      ...
      if (roles.length > 5)
        return await message.channel.send(new MessageEmbed()
          .setColor("#FF6553")
          .setTitle("<:asgard_yorgun_itachiap:939959844784472084> Komutu Yanlış Kullandın!")
      ...
      let embed = new MessageEmbed()
        ...
        .addField("<:asgard_mavi_parlak_yildiz:939958604532940871> Yetkiler", message.guild.roles.cache.filter(r => roles.some(d => d == r.id)).map(r => r.id).map((r, index) => (index + 1) + "- " + message.guild.roles.cache.get(r).toString()).join("\n"))
      return await message.channel.send(embed);
    }
    ...
    if (seçim == "kanal") {
      ...
      .addField(`<:asgard_mavi_parlak_yildiz:939958604532940871> Örnek`, `\`\`\`${prefix[0]}temp-jail kanal #kanal\`\`\``, true)
      .setThumbnail("https://cdn.discordapp.com/attachments/698398041518112898/699064766626267188/giphy.gif")
      .addField(`<:asgard_mavi_parlak_yildiz:939958604532940871> Örnek`, `\`\`\`${prefix[0]}temp-jail kanal ID\`\`\``, true)
      .setFooter(message.author.username + " Tarafından kullanıldı.", message.author.avatarURL({
        dynamic: true
      })));
    ...
    if (seçim == "kişiler") {
      ...
      .addField(`<:asgard_sonsuz:939963115922161764> Örnek`, `\`\`\`${prefix[0]}temp-jail kişiler @etiket1 @etiket2\`\`\``, true)
      .setThumbnail("https://cdn.discordapp.com/attachments/698398041518112898/699064766626267188/giphy.gif")
      .addField(`<:asgard_sonsuz:939963115922161764> Örnek`, `\`\`\`${prefix[0]}temp-jail kişiler ID1 ID2\`\`\``, true)
      .setFooter(message.author.username + " Tarafından kullanıldı.", message.author.avatarURL({
        dynamic: true
      })));
      if (users.length > 10)
      ...
      let embed = new MessageEmbed()
        ...
        .addField("<:asgard_mavi_parlak_yildiz:939958604532940871> Kişiler", message.guild.members.cache.filter(r => users.some(d => d == r.id)).map(r => r.id).map((r, index) => (index + 1) + "- " + message.guild.members.cache.get(r).toString()).join("\n"))
      return await message.channel.send(embed);
    }
    if (seçim == "limit") {
      let limit = args[1];
