...
exports.run = async (client, message, args) => {
  ...
  if (seçim == "bilgi") {
    ...
    let arr2 = await rolAyarlarDB.get(`rolayarlar.vmute_users`) || ["683707976468398227"]
    ...
    .setTitle(`<:asgard_mavi_parlak_yildiz:939958604532940871> Susturma Nedir?`)
    .setColor("RANDOM")
    ...
    .addField(`<:asgard_sonsuz:939963115922161764> **Nasıl kullanılır?**`, `Susturmak için \`${prefix[0]}ses-mute @etiket [sebep] [süre]\` komutunu kullan.`)
    .addField(`<:asgard_sonsuz:939963115922161764> **Cezayı nasıl kaldıracağım?**`, `Susturmayı kaldırmak için \`${prefix[0]}unmute @etiket\` komutunu kullan.`)
    .addField("<:asgard_sonsuz:939963115922161764> **Komutu kimler kullanabilir?**", "Bu komutu **Yönetici** - **Mute Sorumlusu** ya da **Üyeleri Sustur** yetkisine sahip olan kişiler kullanabilir.")
    .addField(`<:asgard_sonsuz:939963115922161764> **Belirlediğim rollere koyabiliyor muyum?**`, `Eğer belirlediğin rollere koymak istiyorsan bunun için \n\`${prefix[0]}ses-mute yetkiler [roller/idler]\` komutunu kullanmalısın.`)
    .addField(`<:asgard_sonsuz:939963115922161764> **Belirlediğim kişileri koyabiliyor muyum?**`, `Eğer belirlediğin kişileri koymak istiyorsan bunun için \n\`${prefix[0]}ses-mute kişiler [kişiler/idler]\` komutunu kullanmalısın.`)
    .addField(`<:asgard_sonsuz:939963115922161764> **Belirlediğim kanala loglatabiliyor muyum?**`, `Eğer belirlediğin kanala loglatmak isteiyorsan bunun için \n\`${prefix[0]}ses-mute kanal [kanal/id]\` komutunu kullanmalısın.`)
...
if (message.member.permissions.has("ADMINISTRATOR") && seçim != "bilgi") {
  if (seçim == "yetkiler") {
    ...
    if (roles.length <= 0)
      return await message.channel.send(new MessageEmbed()
        ...
        .setDescription("Sanırsam rolleri eklemeyi unuttun bu komut hakkında bilgi edinmek için `.mute bilgi` kullanmayı dene.")
        .addField(`<:asgard_mavi_parlak_yildiz:939958604532940871> Örnek`, `\`\`\`${prefix[0]}ses-mute yetkiler @rol1 @rol2 @rol3\`\`\``, true)
        .setThumbnail("https://cdn.discordapp.com/attachments/698398041518112898/699064766626267188/giphy.gif")
        .addField(`<:asgard_mavi_parlak_yildiz:939958604532940871> Örnek`, `\`\`\`${prefix[0]}ses-mute yetkiler ID1 ID2 ID3\`\`\``, true)
        .setFooter(message.author.username + " Tarafından kullanıldı.", message.author.avatarURL({
          dynamic: true
        })));
  ...
  if (seçim == "kanal") {
    ...
    .addField(`<:asgard_mavi_parlak_yildiz:939958604532940871> Örnek`, `\`\`\`${prefix[0]}ses-mute kanal #kanal\`\`\``, true)
    .setThumbnail("https://cdn.discordapp.com/attachments/698398041518112898/699064766626267188/giphy.gif")
    .addField(`<:asgard_mavi_parlak_yildiz:939958604532940871> Örnek`, `\`\`\`${prefix[0]}ses-mute kanal ID\`\`\``, true)
    .setFooter(message.author.username + " Tarafından kullanıldı.", message.author.avatarURL({
      dynamic: true
    })));
  ...
  if (seçim == "kişiler") {
    ...
    .addField(`<:asgard_mavi_parlak_yildiz:939958604532940871> Örnek`, `\`\`\`${prefix[0]}ses-mute kişiler @etiket1 @etiket2\`\`\``, true)
    .setThumbnail("https://cdn.discordapp.com/attachments/698398041518112898/699064766626267188/giphy.gif")
    .addField(`<:asgard_mavi_parlak_yildiz:939958604532940871> Örnek`, `\`\`\`${prefix[0]}ses-mute kişiler ID1 ID2\`\`\``, true)
    .setFooter(message.author.username + " Tarafından kullanıldı.", message.author.avatarURL({
      dynamic: true
    })));
    if (users.length > 10)
